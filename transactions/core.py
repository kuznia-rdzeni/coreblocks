...
class Method:
    ...
    def when_called(self, m : Module, ready=C(1), ret=C(0, 0)):
        ...
        The ``when_called`` function should be used to define body of
        ...
        m : Module
            ...
            ``when_called`` use combinational domain.
        ready : Signal, in
            Signal to indicate if method is ready to be started. By
            default it is Const(1), so method is always ready.
        ret : Signal, in or Record
            Signal or Record which indicate results generated by method.

        Returns
        -------
        data_in : Signal, out or Record
            Signal or Record which method user passed to method call. 
        ...
        sum=Signal(16)
        with my_sum_method.when_called(m, ret=sum) as data_in:
