...
from test.regression.test_regression import run_arch_test  # noqa: E402
from test.regression.test_regression import get_all_arch_test_names  # noqa: E402
...
async def do_test(dut, test_name):
    if test_name == empty_testcase_name:
        return
    await run_arch_test(CocotbSimulation(dut), test_name)


generate_tests(do_test, list(get_all_arch_test_names()) + [empty_testcase_name])
