...
@parameterized_class(
    ...
    [
        ...
        ("csr_mmode", "csr_mmode.asm", 200, {1: 0, 2: 44, 3: 0, 4: 0, 5: 0, 6: 4, 15: 0}, True, configurations.full),
        ("counter_wraparound", "counter_wraparound.asm", 1000, {}, True, configurations.full),
