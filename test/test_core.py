...
@parameterized_class(
    ...
    [
        ...
        ("vcore_bytes", "vector_bytes.asm", 630, {1: 10, 2: 20 + (300%256) * 2**8 + 250 * 2**16, 3:50, 4:100, 5:30, 6:0 + (2550 %256)*2**8, 7:140, 8: (420%256) + (1810 % 256) * 2**8 + 15 * 2**16 + 0x55 * 2**24 }, vector_core_config),
    ],
)
