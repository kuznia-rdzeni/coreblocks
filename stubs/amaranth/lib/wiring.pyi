...
from transactron.utils._typing import ShapeLike, ValueLike, AbstractInterface, AbstractSignature
...
class SignatureMembers(Mapping):
    ...
    """
    def __init__(self, members: Iterable[tuple[str, Member]]=...) -> None:
        ...
    ...
    def flatten(self, *, path: tuple[*str]=...) -> Iterator[tuple[tuple[*str], Member]]:
    ...
    def create(self, *, path=..., src_loc_at=...) -> dict[str, Any]:
...
class FlippedSignatureMembers(Mapping, Generic[_T_SignatureMembers]):
    ...
    def flatten(self, *, path=...) -> Iterator[tuple[tuple[*str], Member]]:
        """Recursively iterate through this collection.
...
class FlippedSignature(Generic[_T_Signature]):
    ...
    def create(self, *args, path=..., src_loc_at=..., **kwargs) -> FlippedInterface:
        ...
...
class PureInterface(Generic[_T_Signature]):
    ...
    def __init__(self, signature: _T_Signature, *, path=..., src_loc_at=...) -> None:
...
def connect(m, *args: AbstractInterface, **kwargs: AbstractInterface) -> None:
