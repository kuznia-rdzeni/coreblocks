...
class MemorySimRead:
    def __init__(self, identity: MemoryIdentity, addr: ValueLike) -> None:
        ...

    def eq(self, value: ValueLike) -> MemorySimWrite:
        ...

class MemorySimWrite:
    def __init__(self, identity: MemoryIdentity, addr: ValueLike, data: ValueLike) -> None:
        ...
